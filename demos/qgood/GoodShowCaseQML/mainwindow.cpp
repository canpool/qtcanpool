...
MainWindow::MainWindow(QWidget *parent) : QGoodWindow(parent, QColor("#303030"))
{
    ...
    m_goodCentralWidget->setIconVisible(false);
    m_goodCentralWidget->setTitleVisible(false);
    m_goodCentralWidget->setCaptionButtonsVisible(false);
    m_goodCentralWidget->setTitleBarHeight(30);
    m_goodCentralWidget->setIconWidth(30);
    ...
    connect(this, &QGoodWindow::captionButtonStateChanged, this, &MainWindow::captionButtonStateChangedPrivate);
    ...
    m_goodCentralWidget->setCentralWidget(m_quick_widget);
...
#else
    m_goodCentralWidget->setTitleBarVisible(false);
...
void MainWindow::captionButtonStateChangedPrivate(const QGoodWindow::CaptionButtonState &state)
{
    ...
    case CaptionButtonState::MinimizeHoverEnter: {
        QMetaObject::invokeMethod(m_quick_widget->rootObject(), "setButtonState", Q_ARG(QVariant, "minBtn"),
                                  Q_ARG(QVariant, "hover_enter"));
        break;
    }
    case CaptionButtonState::MinimizeHoverLeave: {
        QMetaObject::invokeMethod(m_quick_widget->rootObject(), "setButtonState", Q_ARG(QVariant, "minBtn"),
                                  Q_ARG(QVariant, "hover_leave"));
        break;
    }
    case CaptionButtonState::MinimizePress: {
        QMetaObject::invokeMethod(m_quick_widget->rootObject(), "setButtonState", Q_ARG(QVariant, "minBtn"),
                                  Q_ARG(QVariant, "button_press"));
        break;
    }
    case CaptionButtonState::MinimizeRelease: {
        QMetaObject::invokeMethod(m_quick_widget->rootObject(), "setButtonState", Q_ARG(QVariant, "minBtn"),
                                  Q_ARG(QVariant, "button_release"));
        break;
    }
    case CaptionButtonState::MaximizeHoverEnter: {
        QMetaObject::invokeMethod(m_quick_widget->rootObject(), "setButtonState", Q_ARG(QVariant, "maxBtn"),
                                  Q_ARG(QVariant, "hover_enter"));
        break;
    }
    ...
    case CaptionButtonState::CloseHoverEnter: {
        QMetaObject::invokeMethod(m_quick_widget->rootObject(), "setButtonState", Q_ARG(QVariant, "clsBtn"),
                                  Q_ARG(QVariant, "hover_enter"));
        break;
    }
...
bool MainWindow::event(QEvent *event)
{
    ...
    case QEvent::ActivationChange: {
        ...
        m_quick_widget->rootObject()->setProperty("isActive", isActive);
    ...
    case QEvent::WindowStateChange: {
        ...
        if (!change_event->oldState().testFlag(Qt::WindowFullScreen) && !windowState().testFlag(Qt::WindowFullScreen))
            break;

        bool is_full_screen = isFullScreen();
        m_goodCentralWidget->setTitleBarVisible(!is_full_screen);
