...
void MainWindow::setupScatterStyleDemo(QCustomPlot *customPlot)
{
  ...
  for (int i=0; i<shapes.size(); ++i)
  {
    ...
    customPlot->graph()->setName(QLatin1String(QCPScatterStyle::staticMetaObject.enumerator(QCPScatterStyle::staticMetaObject.indexOfEnumerator("ScatterShape")).valueToKey(shapes.at(i))));
