...
void DrawHelpers::draw3DRect(QPainter &pnt, const QColor &colLight, const QColor &colDark, int x, int y, int w, int h,
                             bool up)
{
    QPen savePen = pnt.pen();
...
void DrawHelpers::draw3dRectEx(QPainter &pnt, int x, int y, int cx, int cy, const QColor &clrTopLeft,
...
void DrawHelpers::drawTriangle(QPainter &pnt, const QPoint &pt0, const QPoint &pt1, const QPoint &pt2,
                               const QColor &color)
{
...
void DrawHelpers::drawGradientFill(QPainter &pnt, const QRect &rect, const QColor &crFrom, const QColor &crTo,
                                   bool horz)
{
    pnt.save();
...
double DrawHelpers::MakeHue_TWO(double H) { return MakeHue_ONE(H / 360.0) * 360.0; }
...
int DrawHelpers::getDPI() { return defaultDpiX(); }

int DrawHelpers::getDPIToPercent() { return getDPI() * 100 / logPixel; }
...
QPixmap DrawHelpers::createIconExStyleWidget(QWidget *widget, int width, int height, bool &iconView)
{
    ...
    if (qobject_cast<QToolButton *>(widget)) {
        ...
        {
            friend class QRibbon::DrawHelpers;
        };
...
/*!
    \class QRibbon::StyleOptionFrame
    \internal
*/
...
StyleOptionFrame::StyleOptionFrame(const StyleOptionFrame &other) : QStyleOption(Version, Type) { *this = other; }

StyleOptionFrame::~StyleOptionFrame() {}

/*!
    \class QRibbon::StyleOptionBackstageButton
    \internal
*/
...
/*!
    \class QRibbon::StyleOptionRibbonBackstage
    \internal
*/
StyleOptionRibbonBackstage::StyleOptionRibbonBackstage() { menuWidth = 132; }
...
/*!
    \class QRibbon::StyleOptionRibbon
    \internal
*/
...
StyleOptionRibbon::StyleOptionRibbon(const StyleOptionRibbon &other) : QStyleOption(Version, Type) { *this = other; }

StyleOptionRibbon::~StyleOptionRibbon() {}

/*!
    \class QRibbon::StyleOptionTitleBar
    \internal
*/
...
StyleOptionTitleBar::StyleOptionTitleBar(const StyleOptionTitleBar &other) : QStyleOptionTitleBar(other)
{
    *this = other;
}

/*!
    \class QRibbon::StyleCaptionButton
    \internal
*/
StyleCaptionButton::StyleCaptionButton() {}

StyleCaptionButton::StyleCaptionButton(const StyleCaptionButton &other) : QStyleOptionToolButton(other)
{
    *this = other;
}
...
StyleSystemToolButton::StyleSystemToolButton(const StyleSystemToolButton &other) : QStyleOptionToolButton(other)
{
    *this = other;
}

/*!
    \class QRibbon::StyleHintReturnThemeColor
    \internal
*/
...
/*!
    \class QRibbon::StyleRibbonQuickAccessBar
    \internal
*/
StyleRibbonQuickAccessBar::StyleRibbonQuickAccessBar() { quickAccessBarPosition = RibbonBar::QATopPosition; }

StyleRibbonQuickAccessBar::StyleRibbonQuickAccessBar(const StyleRibbonQuickAccessBar &other) : QStyleOption(other)
{
    *this = other;
}

/*!
\class QRibbon::StyleRibbonOptionHeader
\internal
*/
StyleRibbonOptionHeader::StyleRibbonOptionHeader()
    : QStyleOptionHeader(), contextText(QString("")), tabBarPosition(RibbonBar::TabBarTopPosition)
{
}

StyleRibbonOptionHeader::StyleRibbonOptionHeader(const StyleRibbonOptionHeader &other) : QStyleOptionHeader(other)
{
    *this = other;
