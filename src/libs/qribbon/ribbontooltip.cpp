...
/* RibbonToolTip */
/*!
\brief Constructs RibbonToolTip object with the given \a parent. Parameter \a title - is a title of the tooltip, \a text
- is a text of the tooltip.
*/
...
/*!
\brief Shows tooltip in \a pos position. Parameter \a title - is a title of the tooltip, \a text - is a text of the
tooltip, \a icon - the icon of the tooltip. Parameter \a widget - reference to the widget for calculating the position
of tooltip.
*/
void RibbonToolTip::showToolTip(const QPoint &pos, const QString &title, const QString &text, const QIcon &icon,
                                QWidget *w)
{
    QRect rect;
...
*/
void RibbonToolTip::hideToolTip() { showToolTip(QPoint(), QString(), QString(), QIcon()); }
...
*/
void RibbonToolTip::setWrapMode(WrapMode mode) { RibbonToolTipPrivate::m_wrapMode = mode; }

/*!
Returns the wrap mode for the tooltip's text.
*/
RibbonToolTip::WrapMode RibbonToolTip::wordWrap() { return RibbonToolTipPrivate::m_wrapMode; }

/*!
Sets the visibility of the tooltip's icon to \a visible. Method is static.
*/
void RibbonToolTip::setIconVisible(bool visible) { RibbonToolTipPrivate::m_showIcon = visible; }

/*!
Returns the visibility of the tooltip's icon. Method is static.
*/
bool RibbonToolTip::isIconVisible() { return RibbonToolTipPrivate::m_showIcon; }
...
/*!
    \class QRibbon::RibbonKeyTip
    \internal
*/
RibbonKeyTip::RibbonKeyTip(QWidget *bars, QWidget *owner, const QString &caption, const QPoint &pt, uint align,
